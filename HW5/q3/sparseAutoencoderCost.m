...
% dimension of each training example, the total number of training examples
[ndims, m] = size(data); 

% input to sigmoid func in activation func
...
% initializa derivations of w1,b1,w2,b2
